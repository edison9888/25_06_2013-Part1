...
static NSString* kStreamURL = @"http://www.facebook.com/dialog/feed";
...
//	[self loadURL:kStreamURL method:@"POST" get:getParams post:postParams];
	...
	NSDictionary* getParams = [NSDictionary dictionaryWithObjectsAndKeys:
                               ...
                               [[FacebookTempData sharedManager] getFBShareUrl], @"link",
                               @"fbconnect:success", @"redirect_uri",
							   @"touch", @"display", nil];	
    
	[self loadURL:kStreamURL method:@"GET" get:getParams post:nil];

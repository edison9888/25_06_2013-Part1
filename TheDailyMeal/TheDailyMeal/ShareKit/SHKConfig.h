...
#define SHKMyAppName			@"TheDailyMeal"
#define SHKMyAppURL				@"http://www.thedailymeal.com/"
...
#define SHKFacebookKey				@"169827579749932"
#define SHKFacebookSecret			@"ef8e45e31d3b17766e93df3094bf44f1"
#define SHKFacebookSessionProxyURL  @"http://www.thedailymeal.com/"
 ...
 */
#define SHKTwitterConsumerKey		@"oqrCiNqIWRX5lz6kCGZTQ"
#define SHKTwitterSecret			@"BtnEtZCYFl6loZa23OAyqpVdQk8R9pYZ6tN0lxdmeZU"
#define SHKTwitterCallbackUrl		@"http://www.thedailymeal.com/twitter/oauth" // You need to set this if using OAuth, see note above (xAuth users can skip it)

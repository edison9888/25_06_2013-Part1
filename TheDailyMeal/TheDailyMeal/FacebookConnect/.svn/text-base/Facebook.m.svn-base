...
static NSString* kFBLogin = @"oauth";
...
- (void)authorizeWithFBAppAuth:(BOOL)tryFBAppAuth
    ...
    NSLog(@"AccessTocken%@",self.accessToken);
    ...
    NSString *loginDialogURL = [kDialogBaseURL stringByAppendingString:kFBLogin];
...
- (BOOL)handleOpenURL:(NSURL *)url {
    ...
    NSLog(@"Aceess_Tocken %@",accessToken);
...
- (void)dialog:(NSString *)action
   ...
   andDelegate:(id <FBDialogDelegate>)delegate {
    ...
    if (action == kFBLogin) {
        ...
        NSLog(@"Aceess_Tocken %@",self.accessToken);
...
- (void)fbDialogLogin:(NSString *)token expirationDate:(NSDate *)expirationDate {
    ...
    self.redirectUri = (NSString *)expirationDate;
    if ([self.sessionDelegate respondsToSelector:@selector(fbDidLogin)]) {
        [_sessionDelegate fbDidLogin];
    }
}

- (void)fbDialogLogin:(NSString *)token expirationDate:(NSDate *)expirationDate andRedirectUrl:(NSString *)url{
    self.accessToken = token;
    self.expirationDate = expirationDate;

...
- (void)loadURL:(NSString*)url method:(NSString*)method get:(NSDictionary*)getParams
    ...
    self._loadingURL = [[self generateURL:url params:getParams] retain];
    
    NSMutableURLRequest *request = [[[NSMutableURLRequest alloc] initWithURL:self._loadingURL] autorelease];

...
#define SHKMyAppName			@"Inland Casinos"
#define SHKMyAppURL				@"http://www.pe.com"
...
//#define SHKFacebookKey				@"176127829119240"
//#define SHKFacebookSecret			@"a535f362542abb47c040e4c8be185516"
#define SHKFacebookKey				@"240168819338184"
#define SHKFacebookSecret			@"a92f04e1d6ac8491771ab236eaa8df8c"
 ...
 */
#define SHKTwitterConsumerKey		@"WimmkDiBdVympXawvLNqTQ"
#define SHKTwitterSecret			@"al5dxcPY2NlGEmnyMeE3OSLkqJeXJoYaHn8KUqBwc"
#define SHKTwitterCallbackUrl		@"http://www.pe.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
//#define SHKLog( s, ... ) DebugLog( @"<%p %@:(%d)> %@", self, [[NSString stringWithUTF8String:__FILE__] lastPathComponent], __LINE__, [NSString stringWithFormat:(s), ##__VA_ARGS__] )

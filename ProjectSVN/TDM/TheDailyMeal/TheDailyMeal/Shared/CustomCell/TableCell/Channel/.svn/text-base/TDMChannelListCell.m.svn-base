...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
     ...
     //   [self showDefaultImage];
       ...
       // REMOVE_FROM_MEMORY(channelListCellView);
...
-(void)showImageFromURL:(TDMChannelDetails *)channelDetails {
    ...
    TDMAsyncImage * asyncImageView = (TDMAsyncImage *)[channelListCellView viewWithTag:ASYNC_IMAGE_TAG];
    
    NSLog(@"%@",[channelListCellView viewWithTag:ASYNC_IMAGE_TAG]);
 ...
 //   REMOVE_FROM_MEMORY(asyncImageView);

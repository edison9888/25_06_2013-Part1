...
@interface TDMAssetsTablePicker (Private)
...
@implementation TDMAssetsTablePicker
...
- (void)viewDidLoad
{
    ...
    [useButton setBackgroundImage:[UIImage imageNamed:ACCOUND_BUTTON_IMAGE] forState:UIControlStateNormal];
    ...
    [cancelButton setBackgroundImage:[UIImage imageNamed:ACCOUND_BUTTON_IMAGE] forState:UIControlStateNormal];
    ...
    [self.navigationItem setTDMTitle:@"Loading..."];
...
- (void)enumaratePhotos {
    ...
    [self.navigationItem setTDMTitle:@"Pick Photos"];
    [self moveToLastRow];
    [pool release];

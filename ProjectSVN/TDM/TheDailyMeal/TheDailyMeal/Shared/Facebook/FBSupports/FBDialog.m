...
- (id)initWithSession:(FBSession*)session {
  ...
  if (self) {
    ...
    UIImage* iconImage = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"fbicon" ofType:@"png"]];
    UIImage* closeImage = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"close" ofType:@"png"]];
...
-(void)showAlert:(NSString *)strAlertMessage delegateObject:(id)Delegate {
	...
	UIAlertView *objAlert=[[UIAlertView alloc] initWithTitle:@"Facebook" 
...
- (void)loadString:(NSString*)htmlString baseURL:url  {
...
- (void)dealloc {
    ...
    [_iconView release];
    _iconView = nil;
    _closeButton.imageView.image = nil;

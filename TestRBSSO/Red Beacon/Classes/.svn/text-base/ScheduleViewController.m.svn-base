...
- (void)selectTableCell {
    ...
    int oldRow= (lastIndex != nil) ? [lastIndex row] : -1; //[lastIndex row];
    
    if(presentRow!=oldRow)
    {
        newCell.accessoryType = UITableViewCellAccessoryCheckmark;
        
        UITableViewCell *oldCell = [scheduleTableView cellForRowAtIndexPath:lastIndex]; 

...
{
    JobViewController * jobView = [[JobViewController alloc] initWithNibName:@"JobViewController" bundle:nil];
    jobView.delegate = self;
    UINavigationController * jobController = [[UINavigationController alloc] initWithRootViewController:jobView];
    [jobView release];
    [self.navigationController presentModalViewController:jobController animated:NO];
...
{    
    ...
    {
      jobReq.details = @"(no description - iPhone)";  
    }
    else
    {

...
-(void)drawBarChartWithAFEArray:(NSMutableArray *)modelArray{
    ...
    if(!staticActual)
        staticActual = [[UIImageView alloc]initWithFrame:CGRectMake(353, 150, 16, 16)];
    else
    ...
    if(!staticActualsLabel)
        staticActualsLabel = [[UILabel alloc]initWithFrame:CGRectMake(legandLabelXCor, 150, 100, 16)];
    else 
    ...
    staticActualsLabel = nil;
     if(!accuralsLegand)
        accuralsLegand = [[UIImageView alloc]initWithFrame:CGRectMake(353, 170, 16, 16)];
    else
    ...
    if(!accuralsLabel)
        accuralsLabel = [[UILabel alloc]initWithFrame:CGRectMake(legandLabelXCor, 170, 100, 16)];
    else 
    ...
    for(i = 0; i < 4; i++)
    {
            ...
            CGRect subFrame = CGRectMake(9, 43+frameOffSet, 2, 15);
            ...
            actualbarImageView.image = [UIImage imageNamed:@"yellowbar"];
            ...
            if(!accrualsbarImageView)
                accrualsbarImageView = [[UIImageView alloc]initWithFrame:CGRectMake(actualbarImageView.frame.origin.x+actualbarImageView.frame.size.width+0, 43+frameOffSet, 2, 15)];
            else
            ...
            accrualsbarImageView.image = [UIImage imageNamed:@"redbar"];
                     ...
                     completion:^(BOOL finished)
                     {
                         ...
                         for (UIImageView *barImgeView in barImageArray) 
                         {
                              if(barImgeView.tag >=100)
                             {
                                 ...
                                 {
                                   CGRect tempFrame = CGRectMake(barImgeView.frame.origin.x+barImgeView.frame.size.width+10, barImgeView.frame.origin.y-8, 200, 30);
                                    ...
                                    if(2 <= actualsAccuralsLabel.frame.size.width)
                                     actualsAccuralsLabel.frame = CGRectMake(actualsAccuralsLabel.frame.origin.x+10, actualsAccuralsLabel.frame.origin.y, actualsAccuralsLabel.frame.size.width, actualsAccuralsLabel.frame.size.height);
...
{
    NSLog(@"refreshing data is TopBudgetedAFESummaryView");
    afeArray = afeArrayToUse;
    startDate = start;
    endDate = end;
    self.headerDateLabel.text = [NSString stringWithFormat:@"%@ - %@",[Utility getStringFromDate:start],[Utility getStringFromDate:endDate]];
...
-(void)setPopOver : (int)Tag frame :(CGRect)rect arrowDir:(int)arrowDirection{
    ...
    UILabel *actualLbl = [[UILabel alloc] initWithFrame:CGRectMake(10,0,70,20)];
    ...
    UILabel *actualValLbl = [[UILabel alloc] initWithFrame:CGRectMake(90,0,100,20)];
    actualValLbl.text = [Utility formatNumber:[NSString stringWithFormat:@"%@",tmpAfe.actualsAsStr]];
    ...
    UILabel *accrualLbl = [[UILabel alloc] initWithFrame:CGRectMake(10,20,70,20)];
    ...
    UILabel *accrualLblValLbl = [[UILabel alloc] initWithFrame:CGRectMake(90,20,100,20)];
    accrualLblValLbl.text = [Utility formatNumber:[NSString stringWithFormat:@"%@",tmpAfe.fieldEstimateAsStr]];
    ...
    UILabel *totalLbl = [[UILabel alloc] initWithFrame:CGRectMake(10,40,70,20)];
    totalLbl.text = @"Total          : ";
    ...
    UILabel *totalValLbl = [[UILabel alloc] initWithFrame:CGRectMake(90,40,100,20)];
   // double totalVal = tmpAfe.budget + tmpAfe.actual;
    totalValLbl.text = [NSString stringWithFormat:@"%@",tmpAfe.actualPlusAccrualAsStr];
    ...
    [aPopover setPopoverContentSize:CGSizeMake(180, 60) animated:YES];
    if(arrowDirection)

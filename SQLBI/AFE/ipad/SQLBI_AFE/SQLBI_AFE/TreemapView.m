...
- (void)createNodes {
    ...
    if (nodes && nodes.count > 0) {
        [self calcNodePositions:CGRectMake(0, 0,[[NSUserDefaults standardUserDefaults] integerForKey:@"TREEMAP_WIDTH"],[[NSUserDefaults standardUserDefaults] integerForKey:@"TREEMAP_HEIGHT"])
                          nodes:nodes
                          width:ceil([[NSUserDefaults standardUserDefaults] integerForKey:@"TREEMAP_WIDTH"])
                         height:ceil([[NSUserDefaults standardUserDefaults] integerForKey:@"TREEMAP_HEIGHT"])
                          depth:0
                     withCreate:YES];
    }
}

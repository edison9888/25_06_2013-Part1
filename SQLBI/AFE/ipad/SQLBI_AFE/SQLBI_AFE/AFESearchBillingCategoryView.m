...
-(void) awakeFromNib{
    ...
    sortingParameterTypeArrays = [[NSArray  alloc]initWithObjects:SORTFIELD_BillingCategoryCode,SORTFIELD_BillingCategoryName,SORTFIELD_AFEEstimate,SORTFIELD_Actual,SORTFIELD_Accrual,SORTFIELD_NumberOfInvoices, nil];
...
-(void) getAfeSearchBillingCategoryArray:(NSArray *)afeBillingCategoryArray forPage:(int) page ofTotalPages:(int) totalPages{
    ...
    self.noOfPagesLabel.text = [NSString stringWithFormat:@"Page %d of %d",currentPageShown,totalNoPagesAvailable];

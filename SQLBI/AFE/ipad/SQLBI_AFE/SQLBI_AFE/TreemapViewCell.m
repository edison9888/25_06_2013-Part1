...
- (void)layoutSubviews {
    ...
    textLabel.frame = CGRectMake(0, [[NSUserDefaults standardUserDefaults] integerForKey:@"TREEMAP_WIDTH"] / 2 - 10, self.frame.size.width, 20);
    valueLabel.frame = CGRectMake(0, [[NSUserDefaults standardUserDefaults] integerForKey:@"TREEMAP_WIDTH"] / 2 + 10, self.frame.size.width, 20);
}

...
- (void)populateCustomCellView
{
    ...
    UIView *customCellView= [[UIView alloc]initWithFrame:CGRectMake(1, 0, 390, 55)];
    ...
    self.nameLabel =[[UILabel alloc]initWithFrame:CGRectMake(3, 0, 130, 55)];
    ...
    self.valueLabel =[[UILabel alloc]initWithFrame:CGRectMake(134, 0, 252, 55)];
    ...
    self.percentageValueLabel =[[UILabel alloc]initWithFrame:CGRectMake(296, 0, 90, 55)];

...
@interface AFESearchInvoiceView : UIView<UITableViewDataSource,UITableViewDelegate,UIPopoverControllerDelegate,SortingViewDelegate,AFESearchAPIHandlerDelegate>
{

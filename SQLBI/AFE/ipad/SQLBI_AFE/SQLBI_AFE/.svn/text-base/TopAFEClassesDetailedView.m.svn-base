...
-(void) refreshTableWithAFEClassesArray:(NSArray*) afeClassesArrayToUse forPage:(int) page ofTotalPages:(int) totalPages  andStartDate:(NSDate*) start andEndDate:(NSDate*) end
{
    startDate = start;
    endDate = end;
    self.afeClassesArray_Table = (NSMutableArray*) afeClassesArrayToUse;
...
-(void) createAFEClassesTableView
{
    ...
    [afeClassesTableView refreshTableWithAFEClassesArray:afeClassesArray_Table forPage:currentPageShown ofTotalPages:totalNoPagesAvailable];
}

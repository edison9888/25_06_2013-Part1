...
//    else if([self.treeMapValues isKindOfClass:[NSMutableArray class]])
    ...
    if([self.afeArray count]){
        ...
        //    NSSortDescriptor *sortDescriptor1 = [[NSSortDescriptor alloc] initWithKey:@"self" ascending:NO];
        //    self.treeMapValues = (NSMutableArray *) [self.treeMapValues sortedArrayUsingDescriptors:[NSArray arrayWithObject:sortDescriptor1]];
        //    NSArray *myArray =self.treeMapValues;
        //    NSLog(@"Watchlist %@",myArray);
        //    NSMutableArray *tmpArray = [[NSMutableArray alloc] init];
        //    if([self.treeMapValues count]){
        //        int limit;
        //        if([self.treeMapValues count] > 4){
        //            limit = 5;
        //        }
        //        else
        //            limit = [self.treeMapValues count];
        //            //[self.treeMapValues removeAllObjects];
        //        for(int i =  0 ;i < limit;i++){
        //            NSLog(@"%@",[self.treeMapValues objectAtIndex:i]);
        //            [tmpArray addObject:[self.treeMapValues objectAtIndex:i]];
        //        }
        //        self.treeMapValues = tmpArray;
        //    
        //        
        //    }

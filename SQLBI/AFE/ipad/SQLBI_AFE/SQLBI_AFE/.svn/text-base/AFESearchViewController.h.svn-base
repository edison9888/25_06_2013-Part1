...
@interface AFESearchViewController : AFERootViewController<SearchViewControllerAFEDelegate ,RVBaseAPIHandlerDelegate,PrintANDMailViewDelegate,MFMailComposeViewControllerDelegate>

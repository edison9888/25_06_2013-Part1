...
#import "GVAlertMessageHandler.h"

@implementation GVAlertMessageHandler

NSString * const alertTitle = @"Green Volts";
  ...
  delegateObject:(id)delegate 
{
	...
	[GVAlertMessageHandler showAlert:strAlertMessage 

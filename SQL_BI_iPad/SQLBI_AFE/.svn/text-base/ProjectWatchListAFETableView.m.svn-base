...
#define FRAME_ACTIVITY_INDICATOR_CONTAINER_VIEW CGRectMake(0,46,599,448)
...
-(void) refreshTableWithAFEArray:(NSArray*) afeArrayToUse forPage:(int) page ofTotalPages:(int) totalPages andTotalRecords:(int) totalRecords
{
    ...
    sortingParameterTypeArrays = [[NSArray  alloc]initWithObjects:SORTFIELD_AFENumber,SORTFIELD_AFEEstimate,SORTFIELD_Accrual,SORTFIELD_Actual,SORTFIELD_Total,SORTFIELD_PercentageConsumption, nil];

...
typedef enum RVChartXAxisGranularityLevel
{
    ...
    RVChartXAxisGranularityLevelMonthsDynamically = 9
   // RVChartXAxisGranularityLevelMonthly = 10
...
@interface AFEBurndownChart : UIView<UIPopoverControllerDelegate>
{
    ...
    int maxNumberOfXAxisLabels;
    float xAxisLabelFontSize;
    float yAxisLabelFontSize;    

...
#define SORTFIELD_ServiceMonth @"Date"
*/

#define SORTFIELD_Class @"cn"
#define SORTFIELD_NumberOfAFES @"cnt"
#define SORTFIELD_AFEEstimate @"bud"
#define SORTFIELD_AFEEstimate_InBillingCategory @"bamt"
#define SORTFIELD_Accrual @"acc"
#define SORTFIELD_Actual @"act"
#define SORTFIELD_Total @"apa"
#define SORTFIELD_AFENumber @"num"
#define SORTFIELD_AFEName @"n"
#define SORTFIELD_PercentageConsumption @"pcn"
#define SORTFIELD_BillingCategoryCode @"bc"
#define SORTFIELD_BillingCategoryName @"bcn"
#define SORTFIELD_NumberOfInvoices @"icnt"
#define SORTFIELD_VendorName @"vn"
#define SORTFIELD_InvoiceDate @"idt"
#define SORTFIELD_ServiceDate @"sdt"
#define SORTFIELD_GrossExpense @"gexp"
#define SORTFIELD_InvoiceNumber @"in"
#define SORTFIELD_PropertyName @"pn"
#define SORTFIELD_PropertyType @"pt"
#define SORTFIELD_AccountingDate @"accdt"
#define SORTFIELD_AFEStartDate @"bdt"
#define SORTFIELD_AFEStatus @"st"
#define SORTFIELD_AFEInvoiceAmount @"iamt"
#define SORTFIELD_ServiceMonth @"dt"
...
#define FONT_TREEMAP_VALUE_LABEL_BOLD [UIFont fontWithName:COMMON_FONTNAME_BOLD size:16]

...
-(void) awakeFromNib
{
    ...
    [[NSUserDefaults standardUserDefaults] setInteger:210 forKey:@"pieChartWidth"];
    [[NSUserDefaults standardUserDefaults] setInteger:210 forKey:@"pieChartHeight"];
...
-(void)setData{
    ...
    {
        if(!classNameLabel)
            classNameLabel = [[UILabel alloc]initWithFrame:CGRectMake(382, 138+yOffSet, 100, 15)];
        else
            [classNameLabel removeFromSuperview];
...
-(void)setPieChartValue{
    ...
    self.pieChart.labelFont = [UIFont fontWithName:COMMON_FONTNAME_BOLD size:9];
